...
export default function Armchair({ color }: ArmchairProps) {
  ...
  return (
    <group>
      ...
      {/* Seat cushion */}
      <mesh castShadow receiveShadow position={[0, 0.7, 0.1]}>
        <boxGeometry args={[1, 0.2, 0.8]} />
        <primitive object={material} attach="material" />
      </mesh>

      {/* Armrests */}
      <mesh castShadow receiveShadow position={[-0.5, 0.7, -0.1]}>
